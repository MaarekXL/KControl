 ...
 */
/**
 * @file   BOARD_ESP32_S3_TOUCH_LCD_4_3.h
 * @brief  Configuration file for Waveshare ESP32_S3_TOUCH_LCD_4_3
 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Waveshare:ESP32-S3-LCD-4.3-Non-Touch"
...
#define ESP_PANEL_BOARD_EXPANDER_POST_BEGIN_FUNCTION(p) \
    {  \
        ...
        /* Keep GPIO19/20 connected to native USB instead of the CAN transceiver. */ \
